      ...
      <div className="mx-auto max-w-4xl">
        <header className="border-b border-slate-200 pb-6">
          ...
          <p className="mt-3 text-xs text-slate-500">
            Each card below is a brief generated by the agentic pipeline. Click {" "}
            <a className="font-medium text-slate-700 underline underline-offset-2" href="/pre-meeting-brief/admin">
              Admin
            </a>{" "}
            to type any domain and watch a fresh brief generate live in ~60 seconds.
          </p>
        </header>
        ...
        <footer className="mt-12 border-t border-slate-200 pt-6 text-xs text-slate-500">
          ...
          <span className="mx-2">&middot;</span>
          <a className="underline underline-offset-2" href="/pre-meeting-brief/admin">
